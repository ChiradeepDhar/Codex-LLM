...
def build_offline_demo(settings: Settings) -> DemoResult:
    ...
    report = f"""
# Offline Demo: LLM + Agentic AI Project Assistant
...
""".strip()
    ...
    report_path = write_markdown_report(settings, "offline-demo", report)
